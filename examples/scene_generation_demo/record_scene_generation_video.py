...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="runtime_mcp_video_") as temp:
        ...
        with RuntimeMCPClient() as client:
            ...
            target = {"x": -4510.0, "y": -500.0, "z": ground_z + 60.0}
            ...
            planned = [
                ("bench", "/Game/TokyoStylizedEnvironment/Meshes/Unique_Props/SM_Bench.SM_Bench", {"x": -4620, "y": -500, "z": ground_z + 160}),
                ("table", "/Game/RoofProps/Geometry/Props/SM_table.SM_table", {"x": -4400, "y": -500, "z": ground_z + 160}),
                ("character", "/Game/TokyoStylizedEnvironment/Meshes/Signages/Characters/SM_CharacterA_01.SM_CharacterA_01", {"x": -4800, "y": -700, "z": ground_z + 160}),
            ]
        ...
        command = [get_ffmpeg_exe(), "-y", "-framerate", "8", "-i", str(frame_dir / "frame_%05d.png"), "-vf", "format=yuv420p", "-c:v", "libx264", "-crf", "19", "-movflags", "+faststart", str(output)]
